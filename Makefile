build-zeppelin:
	docker build -t dmitryzagr/zeppelin:0.8.0-rc4-v1-spark2.2.0-hadoop3.0.3 conf/zeppelin
push-zeppelin:
	docker push dmitryzagr/zeppelin:0.8.0-rc4-v1-spark2.2.0-hadoop3.0.3
